...
void setup() {   
  ...
  stroke(0);
  fill(255);
  leftButton = new Button(0, height-150, width/2, 150, "Current ", namesSizeLabel, true);
  rightButton = new Button(width/2, height-150, width/2, 150, "Saved ", int(dbCount), false);
